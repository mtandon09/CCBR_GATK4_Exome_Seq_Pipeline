...
smk_cmd_base="module load snakemake/6.0.5; snakemake --stats snakemake.stats --rerun-incomplete --cluster \"$CLUSTER_OPTS\" --cluster-config $CLUSTER_JSON --keep-going --snakefile $SNAKEFILE $untilarg $configarg"
