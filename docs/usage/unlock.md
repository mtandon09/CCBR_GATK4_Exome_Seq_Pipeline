# <code>exome-seek <b>unlock</b></code>
...
This part of the documentation describes options and concepts for <code>exome-seek <b>unlock</b></code> sub command in more detail. With minimal configuration, the **`unlock`** sub command enables you to unlock a pipeline output directory. 
...
Unlocking exome-seek pipeline output directory is fast and easy! In its most basic form, <code>exome-seek <b>unlock</b></code> only has *one required input*.
...
exome-seek unlock --output /data/$USER/WES_hg38
```